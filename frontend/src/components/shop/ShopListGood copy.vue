...
<template>
  <section class="shops-list">
    ...
    <!-- <div ref="loadMoreTarget" class="shops-load-more">
      <span v-if="isLoading">載入更多店家中...</span>
      <span v-else-if="hasMore">載入更多店家</span>
      <span v-else>已經沒有更多店家了</span>
    </div> -->

    <div ref="loadMoreTarget" class="shop-list__load-more">
      <button
        v-if="hasMore"
        type="button"
      ...
      <p v-else class="shop-list__no-more">已經沒有更多店家了</p>
    </div>
  </section>
</template>
